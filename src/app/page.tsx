  ...
  return (
    <main>
      ...
      <section className="mx-auto min-h-[100dvh] w-full max-w-screen-xl px-5">
        ...
        <div className="mt-72 flex w-full flex-col items-start justify-between gap-10 md:flex-row">
          {/* image */}
          <div className="relative w-full md:w-[60%]">
            <div className="relative z-30 w-full">
              <div className="w-[90%] overflow-hidden rounded-xl border border-gray-700 bg-white/10 md:[transform:perspective(40cm)rotateY(30deg)]">
      ...
      {/* other projects */}
      <section className="relative min-h-[100dvh] pb-72">
          ...
          <div className="relative">
            <div className="hidden md:block">
              <div
                ...
                style={{
                  backgroundImage: `linear-gradient(to right, transparent, rgba(255, 255, 255, 0.15) 24px, rgba(255, 255, 255, 0.15) calc(100% - 24px), transparent)`,
                }}
              ></div>
              <div
              ...
              <div
                ...
                style={{
                  backgroundImage: `linear-gradient(transparent, rgba(255, 255, 255, 0.15) 24px, rgba(255, 255, 255, 0.15) calc(100% - 24px), transparent)`,
                }}
              ></div>
              <div
            ...
            <div className="max-w-md p-3 md:bg-white/[0.05]">
