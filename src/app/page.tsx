...
import about_pic from "../../public/about.png";
import motionridge from "../../public/motionridge.png";
import vooaxis from "../../public/vooaxis.png";
...
export default function Home() {
  return (
    <main>
      {/* hero */}
      <section className="">
        <header className="relative h-[55dvh] w-full bg-gradient-to-b from-black to-gray-900">
          {/* grid pattern */}
          <div className="pointer-events-none absolute inset-x-0 h-full w-full [mask-image:linear-gradient(0deg,transparent,black,transparent)]">
            <div className="pattern -ml-2 -mt-1 h-full w-full opacity-80"></div>
          </div>
          {/* end of grid pattern */}
          <div className="absolute inset-x-0 bottom-0 flex items-center justify-center">
            <div className="relative flex h-full w-full items-center justify-center">
              <div className="absolute z-20 -mt-72 aspect-square w-96 overflow-hidden rounded-[5rem] shadow-lg">
                <Image
                  fill
                  src={profile_pic}
                  placeholder="blur"
              ...
              <div className="absolute z-10 -mt-72 aspect-square w-96 rotate-[15deg] overflow-hidden rounded-[3rem] opacity-65 shadow-lg">
                <Image
                  fill
                  src={profile_pic}
                  placeholder="blur"
        ...
        <div className="mt-28">
          <h1 className="text-center text-6xl font-bold tracking-wide text-gray-800">
            Thuvaragan Parameshwaran
          </h1>
          <p className="mt-3 text-center text-base font-normal tracking-wider text-gray-600">
            Full stack web application developer
          </p>

          {/* links */}
          <div className="mx-auto mt-10 flex items-center justify-center divide-x">
            <div className="pr-5">
              ...
              <div className="mt-2 flex items-center justify-center gap-10">
                <a
                  href="#"
                  className="flex items-center justify-start gap-2 text-sm text-gray-700 hover:text-gray-800 hover:underline"
                >
                  <span className="flex items-center justify-center rounded-full bg-gray-800 p-1 text-white">
                    <svg
                    ...
                    >
                      ...
                      >
                        ...
                        <path
                          ...
                          d="M3.272 16.647c.604 2.255.907 3.383 1.592 4.114a4 4 0 0 0 2.01 1.161c.976.227 2.104-.075 4.36-.679c2.254-.604 3.382-.906 4.113-1.591a4 4 0 0 0 1.068-1.678M8.516 6.445c-.352.091-.739.195-1.165.31c-2.255.604-3.383.906-4.114 1.59a4 4 0 0 0-1.161 2.012c-.161.69-.057 1.456.231 2.643"
                        />
                      </g>
                    </svg>
                  </span>
          ...
          {/* <div className="mt-12 flex items-center justify-center gap-12">
            <div className="flex items-start justify-start gap-2">
              <div className="flex items-center justify-center rounded-full bg-green-100 p-2 text-green-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-7 w-7"
                  viewBox="0 0 24 24"
            ...
            <div className="flex items-start justify-start gap-2">
              <div className="flex items-center justify-center rounded-full bg-pink-100 p-2 text-pink-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-7 w-7"
                  viewBox="0 0 24 24"
      ...
      {/* about */}
      <section className="relative mx-auto mt-10 flex w-full max-w-screen-md items-start justify-between gap-10 py-32">
        <div className="">
          <h3 className="text-3xl font-medium text-gray-800">About me</h3>
          <p className="mt-5 max-w-lg text-base/7 text-gray-800">
            I thrive on collaborating closely with design teams, meticulously
            translating their creative visions into pixel-perfect
            implementations.I am equally adept at working with backend
            technologies and databases, adding a robust foundation to the
            seamless integration of functionality and aesthetics.
          </p>

          <h3 className="mt-10 text-xl font-medium text-gray-800">Technical</h3>
          <p className="max-w-lg text-sm/6 text-gray-700">
            At the moment, I'm deeply immersed in my work, coding with a focus
            on React, Next.js, Prisma, NestJS, Vercel, Netlify, and Firebase. I
            enjoy navigating the realms of JavaScript and TypeScript, HTML, and
            CSS, exploring the vast possibilities these technologies offer to
            bring projects to life.
          </p>

          <h3 className="mt-10 text-xl font-medium text-gray-800">Personal</h3>
          <p className="max-w-lg text-sm/6 text-gray-700">
            Greetings from the misty mountains of Nuwara Eliya, where I first
            learned to code amidst the clouds! A proud alumnus of Lyceum
            International School, I'm currently on a digital odyssey pursuing my
            bachelor's in Computer Science at Eastern University Trincomalee
            campus. Embracing the code with a side of misty mountain charm –
            because why settle for ordinary when you can program with a view?
          </p>
        </div>
        ...
        <div className="absolute inset-y-0 right-0 w-64">
          <Image
            ...
            placeholder="blur"
            className="h-full w-full object-cover grayscale"
            alt='Image of a young boy leaning on a wall <a href="https://www.freepik.com/free-vector/back-school-sketch-college-student-holding-bag-isolated-white-background_29722338.htm#fromView=search&term=men+looking+up+sketch&track=ais&regularType=vector&page=1&position=19&uuid=f2a5f144-ab05-4494-8439-0608a319cee8">Image by Rochak Shukla</a> on Freepik'
          />
        </div>
      </section>
      {/* about */}
      ...
      <section className="relative my-32">
        <div className="mx-auto flex w-full max-w-screen-md items-start justify-between gap-10">
          <div className="w-full">
            <div className="relative inset-x-0 z-20 aspect-video w-full max-w-screen-md rounded-xl border-4 shadow-xl">
              <Image
                fill
                src={motionridge}
                placeholder="blur"
            ...
            <div className="mt-5 flex flex-wrap items-center justify-center gap-5">
              ...
              <a target="_blank" href="https://tailwindcss.com/" className="">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-8 w-8"
                  viewBox="0 0 32 32"
              ...
              <a target="_blank" href="https://www.mongodb.com/" className="">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-8 w-8"
                  viewBox="0 0 256 256"
              ...
              <a target="_blank" href="https://nestjs.com/" className="">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-8 w-8"
                  viewBox="0 0 256 256"
          ...
          <div className="w-full max-w-xs">
            ...
            <p className="mt-2 text-sm/6 text-gray-600">
              Spearheaded the development of multiple web applications using
              Next.js, a React framework, resulting in faster page loading,
              improved SEO, and enhanced user experiences.
            </p>
            <p className="mt-2 text-sm/6 text-gray-600">
              Designed and implemented responsive user interfaces with a focus
              on clean and modern aesthetics using Tailwind CSS, resulting in a
              visually appealing and consistent design system across the
              applications.
            </p>
          </div>
        </div>

        <div className="mx-auto mt-32 flex w-full max-w-screen-md items-start justify-between gap-10">
          <div className="w-full max-w-xs">
            <h4 className="text-xl font-medium text-gray-800">Vooaxis.com</h4>
        ...
        <div className="mx-auto mt-32 flex w-full max-w-screen-md items-start justify-between gap-10">
          ...
          <div className="w-full max-w-xs">
            <h4 className="text-xl font-medium text-gray-800">Kifgo.com</h4>
