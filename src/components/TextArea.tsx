      ...
      >
        ...
        >
          {label && (
            <AnimatePresence initial={false}>
              <label
                htmlFor={id}
                className={`${cn(
                  `mb-1 block text-xs font-medium text-white sm:text-sm`,
                )} 
              ${
                error
          ...
          <textarea
            ...
            ref={ref}
            className={`${cn(
              "block w-full appearance-none rounded-xl border bg-transparent p-3 text-sm text-white transition duration-300 focus:outline-none focus:ring-2 disabled:bg-gray-100 disabled:text-gray-600 ",
              inputClass,
            )} 
            ${
              error
                ...
                : `${cn(
                    `border-gray-700 focus:border-transparent focus:ring-blue-600`,
                    borderClass,
                  )}`
            }
            `}
